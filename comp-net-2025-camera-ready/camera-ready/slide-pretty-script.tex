...
``So what did we find? User weighting helps capture intent. The topology varies by domain---hubs for theory, trees for practice. And we identified three kinds of bridges.''

``But let's be honest about the limitations. This is one user, one platform, one snapshot in time. No ground truth to validate against.''

``Where do we go from here? More users. Track how these networks evolve over time. Proper validation---permutation tests, benchmarks, maybe user studies.''
