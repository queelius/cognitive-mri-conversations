...
``We turn each conversation into a vector. Like word2vec, where `king' and `queen' end up near each other---but for whole conversations. Similar topics land close together in that space.''
