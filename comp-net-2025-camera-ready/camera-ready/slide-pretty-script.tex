...
``What were the key ideas? User-weighted embeddings to capture your intent, not just the AI's responses. Adaptive similarity thresholding to get clean community boundaries. We found heterogeneous topology---theoretical domains form hubs, practical domains form trees. We proposed a taxonomy of bridge types---not necessarily a real thing, just an initial attempt at naming structure we saw. And we ran a 2D ablation study showing these choices weren't arbitrary.''
