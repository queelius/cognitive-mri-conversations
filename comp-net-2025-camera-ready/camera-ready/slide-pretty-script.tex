...
``That gives us two knobs to turn. Alpha: how much to weight user versus AI. And theta---that's our similarity cutoff. How close do two conversations need to be before we draw an edge?''
