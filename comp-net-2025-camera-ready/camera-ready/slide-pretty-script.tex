...
``The key contributions: user-weighted embeddings to capture intent. Adaptive thresholding---theta at 0.9 gives us clean community structure. Heterogeneous topology---theoretical domains form hubs, practical domains form trees. A taxonomy of three bridge types. All validated through a 2D ablation study of 63 configurations.''
