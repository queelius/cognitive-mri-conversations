...
Fig~\ref{fig:attachment} presents the preferential attachment analysis. The degree--attachment correlation is consistently positive and significantly exceeds the null model of random attachment across nearly all months. The median $z$-score is 8.5 (range: 0.5--13.2), indicating strong statistical evidence for preferential attachment.
