...
The dataset comprises 1{,}908 ChatGPT conversations generated by one of the authors between December 2022 and April 2025. Conversations were conducted for authentic research, learning, and problem-solving purposes with no anticipation of future network analysis. Each conversation was embedded using \texttt{nomic-embed-text}~\cite{nussbaum2024nomic} with a 2:1 user:AI message weighting ratio ($\alpha = 2$), validated through a 63-configuration ablation study~\cite{towell2025cognitive}. Pairwise cosine similarities were computed and filtered at threshold $\theta = 0.9$, yielding 601 connected nodes and 1{,}718 edges across 59 connected components, with a giant component of 453 nodes (1{,}307 conversations remain isolated at this threshold). Our previous work~\cite{towell2025cognitive} analyzed the giant component (449 nodes at the time of that analysis); the present work analyzes all connected nodes.
