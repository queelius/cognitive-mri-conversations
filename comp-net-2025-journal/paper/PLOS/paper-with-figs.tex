...
Fig~\ref{fig:community_timeline} shows the community timeline. Several patterns emerge. First, the largest communities (ML/AI, Statistics, Philosophy) are among the earliest born and persist throughout the observation period, consistent with the ``first-mover advantage'' observed in other temporal community studies~\cite{palla2007quantifying}. Second, community births are distributed across the entire period rather than concentrated at the beginning, indicating ongoing diversification of knowledge exploration. Third, community deaths are concentrated among small, specialized communities that emerge briefly and dissolve, often subsumed by their larger neighbors as the network densifies.

\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{community_timeline.pdf}
  \caption{\textbf{Community lifecycles.} Each horizontal ribbon represents one tracked community (maximum size $\geq 10$ nodes), ordered by birth date (earliest at top). Ribbon width at each month is proportional to community size; color indicates dominant topic. Stars mark birth months. The earliest communities (C5, C10) persist throughout the observation period, consistent with first-mover advantage, while later-born communities (C31--C38) grow rapidly during the Reasoning phase.}
